...
public class FileHelper {
	...
	public static byte[] getByteArrayFromFile(RecipientsActivity context, Uri uri) {
		byte[] fileBytes = null;
    ...
    public static byte[] getByteArrayFromFileProfile(ProfilePageActivity context, Uri uri) {
        byte[] fileBytes = null;
        InputStream inStream = null;
        ByteArrayOutputStream outStream = null;
	...
	public static String getFileName(RecipientsActivity context, Uri uri, String fileType) {
    ...
    public static String getFileNameProfile(ProfilePageActivity context, Uri uri, String fileType) {
        String fileName = "uploaded_file.";
